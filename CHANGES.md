...
- Added a **Large Print (ACB/GLOW) Pipeline** in `pipeline_service.py` that audits Word/Excel/PowerPoint/EPUB against the ACB Large Print Guidelines, Microsoft Accessibility Checker rules, and WCAG 2.2 AA
